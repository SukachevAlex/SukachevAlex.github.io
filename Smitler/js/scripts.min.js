...
$(function(){function e(){$(".carousel-services-item").each(function(){var e=$(this),s=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-image").css("min-height",s)})}function s(){$(".carousel-services-content").equalHeights()}$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo-1.svg" alt="Салон красоты s&mitler">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-services").on("initialize.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-services").owlCarousel({loop:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},1200:{items:3}}}).on("changed.owl.carousel",function(){$(".carousel-services .owl-nav").removeClass("disabled")}),$(".carousel-services .owl-nav").removeClass("disabled"),e(),$(".carousel-services-composition .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),s(),window.onresize=function(){s()},$("select").selectize(),$(document).ready(function(){$("form.feedback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){e.trigger("reset"),$(e).find(".success").removeClass("active").fadeOut()},3e3)}),!1})}),$(".carousel-reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,dots:!0,autoHeight:!0}),$(".carousel-partners").owlCarousel({loop:!0,smartSpeed:700,dots:!1,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}).on("changed.owl.carousel",function(){$(".carousel-partners .owl-nav").removeClass("disabled")}),$(".carousel-partners .owl-nav").removeClass("disabled"),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".button-top").addClass("active"):$(".button-top").removeClass("active")}),$(".button-top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(document).ready(function(){$("form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){e.trigger("reset")},1e3)}),!1})})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});